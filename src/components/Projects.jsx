...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      features: [
        'Home Dashboard with Mass and Novena schedules',
        'Parish Assistant Chatbot powered by Gemini AI',
        'Articles & News system with Cloudinary image hosting',
        'Daily Readings & Podcast Directory',
